...
- **swift-format** используется для автоматического форматирования кода. Запустите `swift-format format --in-place --recursive Remission RemissionTests RemissionUITests` перед коммитом.
