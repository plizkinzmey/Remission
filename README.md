...
| **Swift** | 6.2 или выше | Поддержка Swift 6 (strict concurrency) |
| **Swift Package Manager** | встроен в Xcode | Используется для управления зависимостями |
...
- **Основное приложение**: Swift 6.0 (с включённым строгим режимом конкурентности)
- **Тесты**: Swift 5.0+
